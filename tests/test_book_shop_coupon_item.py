...
def test_coupon_item_item_long_before_sell_date():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=49, quality=49)]
...
def test_coupon_item_medium_close_to_sell_date_upper_bound():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=9, quality=10)]
...
def test_coupon_item_medium_close_to_sell_date_upper_bound_and_max_quality():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=9, quality=50)]
...
def test_coupon_item_medium_close_to_sell_date_lower_bound():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=5, quality=10)]
...
def test_coupon_item_medium_close_to_sell_date_lower_bound_and_max_quality():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=5, quality=50)]
...
def test_coupon_item_very_close_to_sell_date_upper_bound():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=4, quality=10)]
...
def test_coupon_item_very_close_to_sell_date_upper_bound_and_max_quality():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=4, quality=50)]
...
def test_coupon_item_very_close_to_sell_date_lower_bound():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=0, quality=10)]
...
def test_coupon_item_very_close_to_sell_date_lower_bound_and_max_quality():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=0, quality=50)]
...
def test_coupon_item_on_sell_date():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=-1, quality=0)]
...
def test_coupon_item_after_sell_date():
    ...
    assert shop.items == [Item('Скидочный купон на курс', sell_in=-2, quality=0)]
